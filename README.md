<h1>Flex Radio SmartCAT PTT (push to talk) with Arduino Nano Every - **[Wiki](https://github.com/w8be/usb-ptt-arduino-nano-every/wiki/Wiki---usb-ptt-artduino-nano-every)**</h1>
